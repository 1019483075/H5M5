...
(function (e) {
    var t = {
        ferroMenuCreate: function (t) {
            function C(e, t, n) {
                if (t.addEventListener)t.addEventListener(e, n, false); else if (t.attachEvent) {
            ...
            function M() {
                e(r + " > li").each(function (t) {
                    ...
                    this.style.transform = "translate(" + n / 2 + "px," + r / 2 + "px)";
                    k(t)
                })
            }
         ...
         function _() {
				e(r + " > li").each(function(t) {
					...
					switch(o) {
						case "left-bottom":
							...
							var u = i.radius * Math.sin(n) * dis;
							var a = i.radius * Math.cos(n) * dis;
							break;
						case "center-bottom":
							e("#" + E).css({
								bottom: 0,
                    ...
                    e(this).css({
                        top: e("#" + E).offset().top + e("#" + E).outerHeight() / 1.5 - e(this).height() / 1.5,
                ...
                //存下当前位置的值
                sessionStorage.setItem("navPosition",o);
            }
            ...
            e("body").append("<a id='" + E + "' data-ferromenuitem='" + r + "' class='ferromenu-controller " + g + " " + y + "' href='javascript:void(0);'><div class='label'><span class='icon-plus'></span></div></a>");
                    ...
                    if (u != null) {
                        if (u.hasClass("open")) {
                            e(t + " > li").each(function (t) {
                                ...
                                this.style.opacity = 1;
                                this.style.webkitTransform = "translate(" + n + "px," + r / 2 + "px) rotate(" + i.rotation + "deg)";
                                ...
                                this.style.transform = "translate(" + n / 1.5 + "px," + r / 1.5 + "px) rotate(" + i.rotation + "deg)";
                                setTimeout(function () {
                                    k(t)
                                }, i.openTime / 1e3)
                            });
